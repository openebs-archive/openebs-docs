...
<img src="/v290/docs/assets/svg/o-mongo.svg" alt="OpenEBS and MongoDB" style="width:400px;">
...
<img src="/v290/docs/assets/svg/mongo-deployment.svg" alt="OpenEBS and Mongo" style="width:100%;">
...
As in most cases, cStor pool may not be dedicated to just Mongo database alone. It is recommended to watch the pool capacity and add more disks to the pool before it hits 80% threshold. See [cStorPool metrics](/v290/docs/next/ugcstor.html#monitor-pool).
