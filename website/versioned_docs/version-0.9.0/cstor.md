...
| kubectl get cvr -n openebs         | Get the list of cStor volume replicas in the entire cluster  |
...
[Pool topology view](/v090/docs/next/mayaonline.html#cstor-pool-view)

[Volume POD topology view](/v090/docs/next/mayaonline.html#cstor-volume-pod-view)

[Volume CR topology view](/v090/docs/next/mayaonline.html#cstor-custom-resources-view)
...
1. **iSCSI tools are not installed or iSCSI.d service is not running**
   ...
   **Resolution**: 
   ...
   Install iSCSI tools and make sure iSCSI service is running. See [iSCSI installation](/v090/docs/next/prerequisites.html)
...
2. **Multi-attach error is seen in the logs**
   ...
   **Resolution :**
   ...
   This is because of the Kubernetes limitation [explained above](/v090/docs/next/cstor.html#known-limitations). OpenEBS CSI driver will resolve this issue. See [roadmap](#cstor-roadmap). In this situation if the node is stuck in a non-responsive state and if the node has to be permanently deleted, remove it from the cluster.  
...
### [Storage Engines in OpenEBS](/v090/docs/next/storageengine.html)

### [Creating cStor Pool](/v090/docs/next/configurepools.html)

### [Provisioning cStor volumes](/v090/docs/next/deploycstor.html)
