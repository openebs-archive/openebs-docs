...
<img src="/v1110/docs/assets/o-cassandra.png" alt="OpenEBS and Prometheus" style="width:400px;">
...
<img src="/v1110/docs/assets/svg/cassandra-deployment.svg" alt="OpenEBS and Cassandra" style="width:100%;">
...
As in most cases, cStor pool may not be dedicated to just Cassandra database alone. It is recommended to watch the pool capacity and add more disks to the pool before it hits 80% threshold. See [cStorPool metrics](/v1110/docs/next/ugcstor.html#monitor-pool). 
