...
<img src="/v290/docs/assets/svg/openebs-arch.svg" alt="drawing" width="80%"/>
...
![Maya is the control plane of OpenEBS](/v290/docs/assets/openebs-maya-architecture.png)
...
![OpenEBS volume pods provisioning-overview](/v290/docs/assets/volume-provisioning.png)
...
![OpenEBS volume exporter data flow](/v290/docs/assets/vol-exporter.png)
...
![volume management sidecars for cStor](/v290/docs/assets/vol-mgmt-sidecars.png)
...
<img src="/v290/docs/assets/svg/ndm.svg" alt="NDM architecture" style="width:70%">
