...
<center><p style="padding: 20px; margin: 20px 0; border-radius: 3px; background-color: #eeeeee;"><strong>
  Documentation for OpenEBS v1.0.0 is no longer actively maintained. The version you are currently viewing is a static snapshot. Click here for the [latest](https://docs.openebs.io) version.
</strong></p></center>
...
See OpenEBS  <a href="/v100/docs/next/features.html">Features & Benefits</a>
and <a href="/v100/docs/next/usecases.html" target="">Use cases</a>.
...
- OpenEBS requires iSCSI client to be configured and iscsid service
  ...
  Verify if [iSCSI service is up](/v100/docs/next/prerequisites.html) and
...
- Default installation works for most cases. As a Kubernetes cluster-admin, start the default installation using either
  ...
  For advanced installation steps, see [Installation](/v100/docs/next/installation.html) section.

- [Verify if OpenEBS is installed successfully](/v100/docs/next/installation.html#verifying-openebs-installation)
  ...
  provision different types of OpenEBS volumes see guides for [cStor volume](/v100/docs/next/ugcstor.html), [Jiva Volume](/v100/docs/next/jivaguide.html) and [OpenEBS local Volume](/v100/docs/next/uglocalpv.html).
...
<div class="row">
  <div class="">
	<a href="/v100/docs/next/usecases.html">
  ...
  <div class="">
	<a href="/v100/docs/next/support.html">
...
<div class="">
	<a href="/docs/next/minio.html" target="_blank">
		<img src="/v100/docs/assets/a-minio.png" alt="OpenEBS Minio" style="float:left;width:100px;">
	</a>
  </div>
<div class="">
	<a href="/docs/next/redis.html" target="_blank">
		<img src="/v100/docs/assets/a-redis.png" alt="OpenEBS Redis" style="float:left;width:100px;">
	</a>
  </div>  
  <div class="">
	<a href="/docs/next/rwm.html" target="_blank">
		<img src="/v100/docs/assets/a-nfs.png" alt="OpenEBS NFS" style="float:left;width:100px;">
	</a>
  </div>
</div>
...
### [Container Attached Storage (CAS)](/v100/docs/next/cas.html)
