...
<img src="/v200/docs/assets/o-minio.png" alt="OpenEBS and Minio" style="width:400px;">
...
Cloud native Object storage is easy to deploy with Minio and OpenEBS. Both run in user space and do not have any kernel dependencies. Minio and OpenEBS start with a very simple configuration of few gigabytes and scale on demand to high capacity.
...
- Storage within a node or pool instance can also be scaled on demand. 
- Complete management of disks under Minio are managed by OpenEBS.
...
<img src="/v200/docs/assets/svg/minio-deployment.svg" alt="OpenEBS and Minio" style="width:100%;">
...
In most cases the cStor pool may not be dedicated to just Minio alone. It is recommended to watch the pool capacity and add more disks to the pool before it hits 80% threshold. See [cStorPool metrics](/v200/docs/next/ugcstor.html#monitor-pool) 
