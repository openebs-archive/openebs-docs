...
One SPC points to multiple CSPs. Similarly one CV points to multiple CVRs. Read detailed explanation of cStor Pools [here](/v290/docs/next/cstor.html#cstor-pools). 
...
### [cStor User Guide](/v290/docs/next/ugcstor.html)

### [Jiva User Guide](/v290/docs/next/jivaguide.html)
