...
One SPC points to multiple CSPs. Similarly one CV points to multiple CVRs. Read detailed explanation of cStor Pools [here](/v270/docs/next/cstor.html#cstor-pools). 
...
### [cStor User Guide](/v270/docs/next/ugcstor.html)

### [Jiva User Guide](/v270/docs/next/jivaguide.html)

### [Local PV Hospath User Guide](/v270/docs/next/uglocalpv-hostpath.html)

### [Local PV Device User Guide](/v270/docs/next/uglocalpv-device.html)
