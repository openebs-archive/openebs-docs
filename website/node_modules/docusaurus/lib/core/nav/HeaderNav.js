          ...
          <header>
            ...
            {env.versioning.enabled && (
               <div className="dropdown">
                 <p className="ver-link">v0.5 <i className="arrow down"></i></p>
                 <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                   <a className="dropdown-item" href="https://docs.openebs.io">latest</a>
                   <a className="dropdown-item" href="https://v06-docs.openebs.io">v0.6</a>
                   <a className="dropdown-item" href={this.props.baseUrl}>v0.5</a>
                 </div>
               </div>
            )}
