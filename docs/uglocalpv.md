...
<img src="/v180/docs/assets/svg/4-config-sequence.svg" alt="OpenEBS configuration flow" style="width:100%">
...
### [Understand OpenEBS Local PVs ](/v180/docs/next/localpv.html)


### [Node Disk Manager](/v180/docs/next/ugndm.html)
