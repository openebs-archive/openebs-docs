...
More details can be find from [here](/v160/docs/next/ugndm.html).
...
### [Understanding Disk Mount Status on Node](/v160/docs/next/faq.html#what-must-be-the-disk-mount-status-on-node-for-provisioning-openebs-volume)
