...
<center><p style="padding: 20px; margin: 20px 0; border-radius: 3px; background-color: #eeeeee;"><strong>
  Documentation for OpenEBS v1.5.0 is no longer actively maintained. The version you are currently viewing is a static snapshot. Click here for the [latest](https://docs.openebs.io) version.
</strong></p></center>
...
See OpenEBS  <a href="/v150/docs/next/features.html">Features & Benefits</a>
and <a href="/v150/docs/next/usecases.html" target="">Use cases</a>.
...
- OpenEBS requires iSCSI client to be configured and iscsid service
  ...
  Verify if [iSCSI service is up](/v150/docs/next/prerequisites.html) and
...
- Default installation works in most  of the cases. As a Kubernetes cluster-admin, start the default installation using either
  ...
  For advanced installation steps, see [Installation](/v150/docs/next/installation.html) section.

- [Verify if OpenEBS is installed successfully](/v150/docs/next/installation.html#verifying-openebs-installation)
  ...
  provision different types of OpenEBS volumes, see guides for [cStor volume](/v150/docs/next/ugcstor.html), [Jiva Volume](/v150/docs/next/jivaguide.html) and [OpenEBS local Volume](/v150/docs/next/uglocalpv.html).
...
### [Container Attached Storage (CAS)](/v150/docs/next/cas.html)
