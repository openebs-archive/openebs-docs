...
5. **Launch and test GitLab**
   ...
   **Note:** You may have to add "fsGroup:1000" under "spec.template.spec.securityContext" in the Prometheus deployment for gitlab to make writable on the volume mount path.
