...
<img src="/v220/docs/assets/svg/4-config-sequence.svg" alt="OpenEBS configuration flow" style="width:100%">
...
### [Understand OpenEBS Local PVs ](/v220/docs/next/localpv.html)

### [Node Disk Manager](/v220/docs/next/ugndm.html)
