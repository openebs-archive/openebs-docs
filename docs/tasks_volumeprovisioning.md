...
3. Unmount the file system using the following commands.
...
7. Restart the replicas. You must delete all the replicas of a pod using a single command. In the following example, Percona is running with a single replica.
...
11. Mount the file system using the following commands.
