...
1. The above procedure works for applications that are either pods or deployments/StatefulSet. In case of the latter, the application pod can be restarted (i.e., deleted) after step-4 (iscsi logout) as the deployment/StatefulSet controller will take care of rescheduling the application on a same/different node with the volume.
...
### [FAQs](/v100/docs/next/faq.html)

### [Seek support or help](/v100/docs/next/support.html)

### [Latest release notes](/v100/docs/next/releases.html)
