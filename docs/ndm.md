...
<img src="/v290/docs/assets/svg/ndm.svg" alt="NDM Architecture" style="width:80%">
...
More details can be found from [here](/v290/docs/next/ugndm.html).
...
### [Understanding Disk Mount Status on Node](/v290/docs/next/faq.html#what-must-be-the-disk-mount-status-on-node-for-provisioning-openebs-volume)
