...
One SPC points to multiple CSPs. Similarly one CV points to multiple CVRs. Read detailed explanation of cStor Pools [here](/v240/docs/next/cstor.html#cstor-pools). 
...
### [Jiva User Guide](/v240/docs/next/jivaguide.html)

### [Local PV Hospath User Guide](/v240/docs/next/uglocalpv-hostpath.html)
