...
<img src="/v220/docs/assets/svg/2-config-sequence.svg" alt="OpenEBS configuration flow" style="width:100%">
...
### [Understanding Node Disk Manager](/v220/docs/next/ndm.html)
