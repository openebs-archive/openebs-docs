...
As in most cases, cStor pool may not be dedicated to just Redis data storage alone. It is recommended to watch the pool capacity and add more disks to the pool before it hits 80% threshold.
