...
MayaOnline topology view of an OpenEBS volume provides [detailed status of all the replicas](/v090/docs/next/mayaonline.html#cstor-custom-resources-view). 
