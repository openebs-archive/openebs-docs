...
For more information on how OpenEBS is used in cloud native environments,  visit the [use cases](/v120/docs/next/usecases.html) section.
...
### [Object Storage with OpenEBS](/v120/docs/next/minio.html)

### [RWM PVs with OpenEBS](/v120/docs/next/rwm.html)

### [Local storage for Prometheus ](/v120/docs/next/prometheus.html)
