...
For more information on how OpenEBS is used in cloud native environments,  visit the [use cases](/v082/docs/next/usecases.html) section.
...
### [Object Storage with OpenEBS](/v082/docs/next/minio.html)

### [RWM PVs with OpenEBS](/v082/docs/next/rwm.html)

### [Local storage for Prometheus ](/v082/docs/next/prometheus.html)
