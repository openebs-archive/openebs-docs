...
One SPC points to multiple CSPs. Similarly one CV points to as CVRs. Read detailed explanation of cStor Pools [here](/1.0.0-RC2/docs/next/cstor.html#cstor-pools). 
...
### [Jiva overview](/1.0.0-RC2/docs/next/jiva.html)
