...
<img src="/v190/docs/assets/svg/ndm.svg" alt="NDM Architecture" style="width:80%">
...
More details can be find from [here](/v190/docs/next/ugndm.html).
...
### [Local PV User Guide](/v190/docs/next/uglocalpv-device.html)

### [cStor User Guide](/v190/docs/next/ugcstor.html)

### [Understanding Disk Mount Status on Node](/v190/docs/next/faq.html#what-must-be-the-disk-mount-status-on-node-for-provisioning-openebs-volume)
