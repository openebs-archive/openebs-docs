...
<img src="/v1100/docs/assets/svg/6-config-sequence.svg" alt="OpenEBS configuration flow" style="width:100%">

<br>

For details of how Jiva works, see <a href="/v1100/docs/next/jiva.html" >Jiva overview page</a>
...
To know more about mount status <a href="/v1100/docs/next/faq.html#what-must-be-the-disk-mount-status-on-node-for-provisioning-openebs-volume" target="_blank">click here</a>.
 ...
 <li>
First, You need to <b>Create a Jiva Pool</b> specifying the filesystem path on each node. To know about the detailed steps <a href="/v1100/docs/next/jivaguide.html#create-a-pool" target="_blank">click here.</a>  
</li>
<li>
Using this storage pool, create a storage class by referring<a href="/v1100/docs/next/jivaguide.html#create-a-sc" target="_blank"> here.</a>
 </li>
 <li>
...
### [Understanding Jiva](/v1100/docs/next/jiva.html)
