...
| -------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| <br/><font size="5">0.8.2</font> | <br> <font size="4">Latest Release</font> <br/> <br>(Recommended)<br/><br> [Release Blog]() <br/> <br>[Release Notes](https://github.com/openebs/openebs/releases/tag/0.8.2) | - Enhanced cStor volume deletion<br>- Implemented toleration policy support for cStorStoragePool.<br>- |
