...
See OpenEBS  <a href="/v082/docs/next/features.html">Features & Benefits</a>
and <a href="/v082/docs/next/usecases.html" target="">Use cases</a>.
...
Verify if [iSCSI service is up](/v082/docs/next/prerequisites.html) and
...
[Installation](/v082/docs/next/installation.html) section.

- [Verify if OpenEBS is installed successfully](/v082/docs/next/installation.html#verifying-openebs-installation)
...
[provisioning OpenEBS volumes](/v082/docs/next/provisionvols.html)
...
### [Container Attached Storage (CAS)](/v082/docs/next/cas.html)
