...
Director Online topology view of an OpenEBS volume provides [detailed status of all the replicas](/v130/docs/next/directoronline.html#cstor-custom-resources-view). 
...
### [Connecting to Director Online](/v130/docs/next/directoronline.html)
