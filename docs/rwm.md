...
<img src="/v240/docs/assets/svg/rwm-single.svg" alt="OpenEBS and NFS provisioner" style="width:100%;">
...
Select or <a href="/v240/docs/next/ugcstor.html#creating-cStor-storage-pools">create a cStor pool</a> that satisfies the performance, and availability requirements

<br>

**Select or create a cStor storage Class**

<a href="/v240/docs/next/ugcstor.html#creating-cStor-storage-class">Create a storage class</a> to point to the above selected pool and also select number of replicas and default size of the volume. 
...
<img src="/v240/docs/assets/svg/rwm-multiple.svg" alt="OpenEBS and NFS provisioner" style="width:100%;">
...
### [cStor Overview](/v240/docs/next/cstor.html)

### [cStorPools](/v240/docs/next/ugcstor.html#creating-cStor-storage-pools)

### [Setting up Object Storage](/v240/docs/next/minio.html)
