...
<img src="/v260/docs/assets/svg/openebs-arch.svg" alt="drawing" width="80%"/>
...
![Maya is the control plane of OpenEBS](/v260/docs/assets/openebs-maya-architecture.png)
...
![OpenEBS volume pods provisioning-overview](/v260/docs/assets/volume-provisioning.png)
...
![OpenEBS volume exporter data flow](/v260/docs/assets/vol-exporter.png)
...
![volume management sidecars for cStor](/v260/docs/assets/vol-mgmt-sidecars.png)
...
<img src="/v260/docs/assets/svg/ndm.svg" alt="NDM architecture" style="width:70%">
...
### [Understanding NDM](/v260/docs/next/ndm.html)
