...
One SPC points to multiple CSPs. Similarly one CV points to multiple CVRs. Read detailed explanation of cStor Pools [here](/v1110/docs/next/cstor.html#cstor-pools). 
...
### [cStor User Guide](/v1110/docs/next/ugcstor.html)

### [Jiva User Guide](/v1110/docs/next/jivaguide.html)

### [Local PV Hospath User Guide](/v1110/docs/next/uglocalpv-hostpath.html)

### [Local PV Device User Guide](/v1110/docs/next/uglocalpv-device.html)
