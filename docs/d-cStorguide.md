...
------
   ...
   :::note 
   With OpenEBS 2.0, the recommended approach to provision cStor Pools is to use cStorPoolCluster(CSPC). For detailed instructions on how to get started with new cStor Operators please refer <a href="/docs/next/ugcstor-csi.html" target="_blank">here</a>.
   :::
