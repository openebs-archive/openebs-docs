...
For more information on how OpenEBS is used in cloud native environments,  visit the [use cases](/v130/docs/next/usecases.html) section.
...
### [Object Storage with OpenEBS](/v130/docs/next/minio.html)

### [RWM PVs with OpenEBS](/v130/docs/next/rwm.html)

### [Local storage for Prometheus ](/v130/docs/next/prometheus.html)
