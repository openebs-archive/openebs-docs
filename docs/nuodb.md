...
<img src="/v260/docs/assets/o-nuodb.png" alt="OpenEBS and Nuodb" style="width:400px;">
...
<img src="/v260/docs/assets/svg/nuodb-deployment.svg" alt="OpenEBS and NuoDB" style="width:100%;">
...
As in most cases, cStor pool may not be dedicated to just NuoDB database alone. It is recommended to watch the pool capacity and add more disks to the pool before it hits 80% threshold. See [cStorPool metrics](/v260/docs/next/ugcstor.html#monitor-pool) 
