...
<img src="/v2100/docs/assets/o-postgres.png" alt="OpenEBS and PostgreSQL" style="width:400px;">	
...
<a href="/v2100/docs/assets/svg/StackGres-Postgres-LocalPV.svg" target="_blank"><img src="/docs/assets/svg/StackGres-Postgres-LocalPV.svg" alt="OpenEBS and StackGres PostgreSQL localpv device" style="width:100%;"></a>
...
1. [Install OpenEBS](/v2100/docs/next/postgres.html#install-openebs)
2. [Select OpenEBS storage engine](/v2100/docs/next/postgres.html#select-openebs-storage-engine)
3. [Configure OpenEBS Local PV StorageClass](/v2100/docs/next/postgres.html#configure-openebs-local-pv-storageclass)
4. [Installing StackGres PostgreSQL Operator](/v2100/docs/next/postgres.html#installing-stackgres-postgresql-operator)
5. [Installing PostgreSQL Database](/v2100/docs/next/postgres.html#installing-postgresql-database)
6. [Accessing PostgreSQL database](/v2100/docs/next/postgres.html#accessing-postgresql-database)
