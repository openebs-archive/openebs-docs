...
<img src="/v170/docs/assets/o-elastic.png" alt="OpenEBS and Elasticsearch" style="width:400px;">
...
<img src="/v170/docs/assets/svg/elasticsearch-deployment.svg" alt="OpenEBS and Elasticsearch" style="width:100%;">
...
As in most cases, cStor pool may not be dedicated to just Elasticsearch database alone. It is recommended to watch the pool capacity and add more disks to the pool before it hits 80% threshold. See [cStorPool metrics](/v170/docs/next/ugcstor.html#monitor-pool). 
