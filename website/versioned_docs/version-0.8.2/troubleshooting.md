---
id: version-0.8.2-troubleshooting
...
You must enable RBAC on Azure before OpenEBS installation. For more details, see [Prerequisites](/v082/docs/next/prerequisites.html).
...
Go through the Kubelet logs and application pod logs to know the reason for marking the ReadOnly and take appropriate action. [Maintaining volume quorum](/v082/docs/next/k8supgrades.html) is necessary during Kuberntes node reboots. 
...
More details are mentioned [here](/v082/docs/next/prerequisites.html#rancher).
...
### [FAQs](/v082/docs/next/faq.html)

### [Seek support or help](/v082/docs/next/support.html)

### [Latest release notes](/v082/docs/next/releases.html)
