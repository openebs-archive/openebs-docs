...
> The resiliency of the control plane can be verified via `litmus` using <a href="https://docs.litmuschaos.io/docs/next/openebs-control-plane-validation/"> openebs-control-plane-validation </a> experiment.
