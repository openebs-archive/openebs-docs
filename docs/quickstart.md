...
<div class="emphasize">
    <ul>
        ...
        <li>For applications requiring high performance, which manage their own replication, data protection and other storage features, provision OpenEBS Local PV. More details can be found from <a href="/docs/next/uglocalpv-device.html">here.</a></li>
    </ul>
