...
.mainContainer .wrapper em,
.mainContainer .wrapper i {
  font-style: italic;
}

.mainContainer .wrapper strong,
.mainContainer .wrapper b {
  font-weight: bold;
}
...
/** This css code is for MayaOnline Login Button i.e the mayaonline logo itself**/
.float{
  position:fixed;
  height:40px;
  bottom:15%;
...
@supports(position: sticky) {
  @media only screen and (min-width: 1024px) {
    .separateOnPageNav.doc .wrapper, .separateOnPageNav .headerWrapper.wrapper {
      max-width: 100%;
    }
