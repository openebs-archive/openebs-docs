...
<img src="/v220/docs/assets/o-postgres.png" alt="OpenEBS and PostgreSQL" style="width:400px;">	
...
<img src="/v220/docs/assets/svg/postgresql-deployment.svg" alt="OpenEBS and PostgreSQL" style="width:100%;">
...
In some cases the cStor pool may not be dedicated to only the PostgreSQL database. It is recommended to watch the pool capacity and add more disks to the pool before it hits 80% threshold. See [cStorPool metrics](/v220/docs/next/ugcstor.html#monitor-pool). 
