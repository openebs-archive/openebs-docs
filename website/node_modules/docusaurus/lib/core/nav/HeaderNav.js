          ...
          <header>
            ...
            {env.versioning.enabled && (
               <div className="dropdown">
                 <p className="ver-link">v0.5-latest <i className="arrow down"></i></p>
                 <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                   <a className="dropdown-item" href={this.props.baseUrl}>v0.5-latest</a>
                   <a className="dropdown-item" href="https://v05-docs.openebs.io">v0.5-old</a>
                 </div>
               </div>
            )}
