...
MayaOnline topology view of an OpenEBS volume provides [detailed status of all the replicas](/v082/docs/next/mayaonline.html#cstor-custom-resources-view). 
