...
For more information on how OpenEBS is used in cloud native environments,  visit the [use cases](/v220/docs/next/usecases.html) section or see examples of users and their stories on the OpenEBS Adopters section [here](https://github.com/openebs/openebs/blob/master/ADOPTERS.md) where you can also share your experience.
...
<img src="/v220/docs/assets/svg/f-replication.svg" alt="Synchronous Replication Icon" style="width:200px;">
...
<img src="/v220/docs/assets/svg/f-snapshots.svg" alt="Snapshots and Clones Icon" style="width:200px;">
...
<img src="/v220/docs/assets/svg/f-backup.svg" alt="Backup and Restore Icon" style="width:200px;">
...
<img src="/v220/docs/assets/svg/f-prometheus.svg" alt="Prometheus and Tuning Icon" style="width:200px;">
...
<img src="/v220/docs/assets/svg/b-cn.svg" alt="Cloud Native Storage Icon" style="width:200px;"> 
...
<img src="/v220/docs/assets/svg/b-no-lockin.svg" alt="Avoid Cloud Lockin Icon" style="width:200px;">
...
<img src="/v220/docs/assets/svg/b-granular.svg" alt="Workload Granular Policies Icon" style="width:200px;">
...
### Reduced Storage TCO up to 50% 
 ...
 <img src="/v220/docs/assets/svg/b-lowtco.svg" alt="Reduced Storage TCO Icon" style="width:200px;">
...
<img src="/v220/docs/assets/svg/b-hci.svg" alt="Natively HCI on K8s Icon" style="width:200px;">
...
<img src="/v220/docs/assets/svg/b-ha.svg" alt="High Availability Icon" style="width:200px;"> 
...
### [Object Storage with OpenEBS](/v220/docs/next/minio.html)

### [RWM PVs with OpenEBS](/v220/docs/next/rwm.html)

### [Local storage for Prometheus ](/v220/docs/next/prometheus.html)
