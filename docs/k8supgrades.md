...
MayaOnline topology view of an OpenEBS volume provides [detailed status of all the replicas](/1.0.0-RC2/docs/next/mayaonline.html#cstor-custom-resources-view). 
