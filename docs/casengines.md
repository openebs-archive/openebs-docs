...
One SPC points to multiple CSPs. Similarly one CV points to multiple CVRs. Read detailed explanation of cStor Pools [here](/v170/docs/next/cstor.html#cstor-pools). 
...
### [cStor User Guide](/v170/docs/next/ugcstor.html)

### [Jiva User Guide](/v170/docs/next/jivaguide.html)
