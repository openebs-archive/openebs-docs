...
For details of how Jiva works, see <a href="/v120/docs/next/jiva.html" >Jiva overview page</a>
...
To know more about blockdevice mount status <a href="/v120/docs/next/faq.html#what-must-be-the-disk-mount-status-on-node-for-provisioning-openebs-volume" target="_blank">click here</a>.
 </li>
 <li>
...
To know about the detailed steps <a href="/v120/docs/next/jivaguide.html#create-a-pool" target="_blank">click here.</a> The name specified under <b>StoragePool</b> YAML needs to be mentioned in StorageClass YAML in the next step.
 </li>
 <li>
Now, <b>create a StorageClass</b> , specifying the StoragePool name under `annotations` in the <b>StorageClass</b> YAML.
To get detailed steps <a href="/v120/docs/next/jivaguide.html#create-a-sc" target="_blank">click here.</a>
 </li>
 <li>
...
### [Understanding Jiva](/v120/docs/next/jiva.html)
