...
<img src="/v290/docs/assets/o-minio.png" alt="OpenEBS and MinIO" style="width:400px;">
...
<img src="/v290/docs/assets/svg/Local-PV-Distributed-device-minio.svg" alt="OpenEBS and MinIO Distributed localpv device" style="width:100%;">
...
1. [Install OpenEBS](/v290/docs/next/minio.html#install-openebs)
2. [Select OpenEBS storage engine](/v290/docs/next/minio.html#select-openebs-storage-engine)
3. [Configure OpenEBS Local PV StorageClass](/v290/docs/next/minio.html#configure-openebs-local-pv-storageclass)
4. [Install the MinIO plugin](/v290/docs/next/minio.html#install-the-minio-plugin)
5. [Install the MinIO operator deployment](/v290/docs/next/minio.html#install-the-minio-operator-deployment)
6. [Install the MinIO cluster](/v290/docs/next/minio.html#install-the-minio-cluster)
7. [Access MinIO console](/v290/docs/next/minio.html#access-minio-console)
