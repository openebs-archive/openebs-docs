...
<img src="/v1110/docs/assets/svg/2-config-sequence.svg" alt="OpenEBS configuration flow" style="width:100%">
...
### [Understanding Node Disk Manager](/v1110/docs/next/ndm.html)
