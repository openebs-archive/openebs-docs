...
Documentation for OpenEBS v2.3.0 is no longer actively maintained. The version you are currently viewing is a static 
...
| High Availability, Synchronous replication, Thin provisioning | hostpath or external mounted storage | [OpenEBS Jiva](/v230/docs/next/jivaguide.html)
| Low latency, Local PV | hostpath or external mounted storage | [Dynamic Local PV - Hostpath](/v230/docs/next/uglocalpv-hostpath.html)
| Low latency, Local PV | Disks/SSDs/Cloud Volumes | [Dynamic Local PV - Device](/v230/docs/next/uglocalpv-device.html)
...
- [Local PV hostpath](/v230/docs/next/uglocalpv-hostpath.html)
- [Local PV device](/v230/docs/next/uglocalpv-device.html)
...
- [Jiva](/v230/docs/next/installation.html)
...
<div class="row">
  <div class="">
	<a href="/v230/docs/next/architecture.html">
		<img src="/v230/docs/assets/intro-arch.png" alt="OpenEBS Architecture" style="float:left;width:250px;">
	</a>
  </div>
  <div class="">
	<a href="/v230/docs/next/quickstart.html">
		<img src="/v230/docs/assets/intro-gs.png" alt="OpenEBS quick start" style="float:left;width:250px;">
	</a>
  </div>
  <div class="">
	<a href="/v230/docs/next/prerequisites.html">
		<img src="/v230/docs/assets/intro-platforms.png" alt="OpenEBS platforms" style="float:left;width:250px;">
	</a>
  </div>
</div>
<div class="row">
  <div class="">
	<a href="/v230/docs/next/usecases.html">
		<img src="/v230/docs/assets/intro-uc.png" alt="OpenEBS use cases" style="float:left;width:250px;">
	</a>
  </div>
  <div class="">
	<a href="/v230/docs/next/troubleshooting.html">
		<img src="/v230/docs/assets/intro-tsg.svg" alt="Troubleshooting OpenEBS" style="float:left;width:250px;">
	</a>
  </div>
  <div class="">
	<a href="/v230/docs/next/support.html">
		<img src="/v230/docs/assets/intro-support.png" alt="OpenEBS Support" style="float:left;width:250px;">
	</a>
  </div>
</div>
<br>
...
<div class="row stateful-applications_row">
    <div class="">
	<a href="/v230/docs/next/prometheus.html" target="_blank">
		<img src="/v230/docs/assets/a-prometheus.png" alt="OpenEBS Architecture" style="float:left;width:100px;">
	</a>
  </div>
<div class="">
	<a href="/v230/docs/next/gitlab.html" target="_blank">
		<img src="/v230/docs/assets/a-gitlab.png" alt="OpenEBS Archipdate ntecture" style="float:left;width:100px;">
	</a>
  </div>
  <div class="">
	<a href="/v230/docs/next/cassandra.html" target="_blank">
		<img src="/v230/docs/assets/a-cassandra.png" alt="OpenEBS Architecture" style="float:left;width:100px;">
	</a>
  </div>
</div>
<br>
<div class="row stateful-applications_row">
<div class="">
	<a href="/v230/docs/next/minio.html" target="_blank">
		<img src="/v230/docs/assets/a-minio.png" alt="OpenEBS Minio" style="float:left;width:100px;">
	</a>
  </div>
<div class="">
	<a href="/v230/docs/next/redis.html" target="_blank">
		<img src="/v230/docs/assets/a-redis.png" alt="OpenEBS Redis" style="float:left;width:100px;">
	</a>
  </div>  
  <div class="">
	<a href="/v230/docs/next/rwm.html" target="_blank">
		<img src="/v230/docs/assets/a-nfs.png" alt="OpenEBS NFS" style="float:left;width:100px;">
	</a>
  </div>
</div>
<br>
<div class="row stateful-applications_row">
<div class="">
	<a href="/v230/docs/next/elasticsearch.html" target="_blank">
		<img src="/v230/docs/assets/a-elastic.png" alt="OpenEBS Architecture" style="float:left;width:100px;">
	</a>
  </div>
<div class="">
	<a href="/v230/docs/next/mysql.html" target="_blank">
		<img src="/v230/docs/assets/a-mysql.png" alt="OpenEBS Architecture" style="float:left;width:100px;">
	</a>
  </div>  
  <div class="">
	<a href="/v230/docs/next/postgres.html" target="_blank">
		<img src="/v230/docs/assets/a-postgres.png" alt="OpenEBS Architecture" style="float:left;width:100px;">
	</a>
  </div>
</div>
<br>
<div class="row stateful-applications_row">
  <div class="">
	<a href="/v230/docs/next/percona.html" target="_blank">
		<img src="/v230/docs/assets/a-percona.png" alt="OpenEBS for Percona" style="float:left;width:100px;">
	</a>
  </div>
  <div class="">
	<a href="/v230/docs/next/nuodb.html" target="_blank">
		<img src="/v230/docs/assets/a-nuodb.png" alt="OpenEBS for NuoDB" style="float:left;width:100px;">
	</a>
  </div>
 <div class="">
	<a href="/v230/docs/next/mongo.html" target="_blank">
		<img src="/v230/docs/assets/svg/a-mongo.svg" alt="OpenEBS for MongoDB" style="float:left;width:100px;">
	</a>
  </div>
</div>
<br><br>
...
### [Container Attached Storage (CAS)](/v230/docs/next/cas.html)
