...
More details can be find from [here](/v130/docs/next/ugndm.html).
...
### [Understanding Disk Mount Status on Node](/v130/docs/next/faq.html#what-must-be-the-disk-mount-status-on-node-for-provisioning-openebs-volume)
